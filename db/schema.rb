...
ActiveRecord::Schema.define(version: 2020_07_07_103100) do
  ...
  create_table "dialplans", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "title"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "groups_tranks", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "trank_id"
    t.bigint "group_id"
  ...
  create_table "lead_statuses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "spools", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
